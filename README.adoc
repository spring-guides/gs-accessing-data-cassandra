...
You can use this https://start.spring.io/#!type=maven-project&language=java&platformVersion=2.6.4&packaging=jar&jvmVersion=1.8&groupId=com.example&artifactId=demo&name=Accessing%20Data%20with%20Cassandra&description=Accessing%20Data%20with%20Cassandra&packageName=com.example.gs-accessing-data-cassandra&dependencies=data-cassandra[pre-initialized project] and click Generate to download a ZIP file. This project is configured to fit the examples in this tutorial.
