...
Apache Cassandra is an open-source NoSQL data store optimized for fast reads and fast writes in large datasets. In this guide you'll use the free tier of https://dtsx.io/3i9C8t1[DataStax Astra] Cassandra-as-a-Service. You'll be able to create and store data in your Cassandra database in a matter of minutes.
