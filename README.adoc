...
Apache Cassandra is an open-source NoSQL data store optimized for fast reads and fast writes in large datasets. In the next subsections, you can choose between using https://dtsx.io/3i9C8t1[DataStax Astra] Cassandra-as-a-Service or running it locally on a Docker container.
...
=== Astra setup and configuration

To use a managed database, you can use the free tier of https://dtsx.io/3i9C8t1[DataStax Astra] Cassandra-as-a-Service. You'll be able to create and store data in your Cassandra database in a matter of minutes.

Follow the instructions in https://docs.datastax.com/en/astra/docs/gs-grant-user-access.html[the following link] to create a database and keystore named `spring_cassandra`.
